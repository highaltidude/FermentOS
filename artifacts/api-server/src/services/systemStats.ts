...
// Container-limit-aware memory pressure, matching what the frontend computed
// client-side previously — kept here so the live view and the history sampler
// always agree on the same number.
export function computeMemoryPressurePercent(stats: SystemStats): number {
